...
import { DetailTabletInfo } from './DetailTabletInfo';
...
const DetailData = ({ data, productId, mutate }) => {
	...
	const [screen, setScreen] = useState(
		data?.screen || DetailTabletInfo.screen
	);
	const [operatingSystemAndCPU, setOperatingSystemAndCPU] = useState(
		data?.operatingSystemAndCPU || DetailTabletInfo.operatingSystemAndCPU
	);
	const [ramRom, setRamRom] = useState(
		data?.ramRom || DetailTabletInfo.ramRom
	);
	const [camera, setCamera] = useState(
		data?.camera || DetailTabletInfo.camera
	);
	const [selfie, setSelfie] = useState(
		data?.selfie || DetailTabletInfo.selfie
	);
	const [connection, setConnection] = useState(
		data?.connection || DetailTabletInfo.connection
	);
	const [utility, setUtility] = useState(
		data?.utility || DetailTabletInfo.utility
	);
	const [batteryAndCharger, setBatteryAndCharger] = useState(
		data?.batteryAndCharger || DetailTabletInfo.batteryAndCharger
	);
	const [generalInformation, setGeneralInformation] = useState(
		data?.generalInformation || DetailTabletInfo.generalInformation
	);
	const [loading, setLoading] = useState(false);
